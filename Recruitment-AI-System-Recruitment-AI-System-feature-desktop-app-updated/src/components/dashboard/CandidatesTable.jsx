                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {candidate.photo ? (
                      <img
                        ...
                        className="w-20 h-20 rounded-full object-cover border-2 border-blue-200 shadow flex-shrink-0"
                      />
                    ) : (
                      <div className="w-20 h-20 rounded-full bg-blue-500 flex items-center justify-center text-white text-xl font-bold border-2 border-blue-200 shadow flex-shrink-0">
