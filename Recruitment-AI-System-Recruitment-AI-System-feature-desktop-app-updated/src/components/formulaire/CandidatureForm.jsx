        ...
        <div className="mb-6">
          ...
          <div className="mb-6 p-5 bg-gray-50 rounded-xl border border-gray-200">
            <label className="block text-gray-700 text-sm font-medium mb-3">
              ...
              <span className="text-gray-400 font-normal ml-2">(JPG, PNG — max 2 MB)</span>
            </label>
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex-shrink-0">
                {photoPreview ? (
                  ...
                  <div className="w-24 h-24 rounded-full bg-blue-100 border-4 border-blue-200 flex items-center justify-center text-blue-400 text-2xl font-bold shadow">
                    {getInitials()}
                  </div>
                )}
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                {photoPreview && (
                  <button
                    ...
                    className="px-4 py-2 bg-white text-red-500 border border-red-300 rounded-lg text-sm font-medium hover:bg-red-50 transition flex items-center gap-2"
                  >
                    🗑️ Supprimer
                  </button>
                )}
                ...
                <p className="text-xs text-gray-400 mt-1">
                  {photoPreview ? '✅ Photo sélectionnée' : 'Aucune photo sélectionnée'}
                </p>
              </div>
            </div>
